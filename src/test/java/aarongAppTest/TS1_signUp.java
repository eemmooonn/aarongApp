...
public class TS1_signUp extends setup{
	...
	public void signUp()
	{
		...
		driver.findElement(By.id("etFirstName")).sendKeys("Test1020");
		driver.findElement(By.id("etLastName")).sendKeys("Automation");
		driver.findElement(By.id("etMobileNumber")).sendKeys("01332345123");
		driver.findElement(By.id("etGender")).click();
		driver.findElement(By.id("tvRegister")).click();
		driver.findElement(By.id("btnContinue")).click();
		driver.findElement(By.id("etEmail")).sendKeys("test1020@gmail.com");
